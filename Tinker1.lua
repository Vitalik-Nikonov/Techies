local Tinkerr = {}
Tinker.IsEnabled = Menu.AddOptionBool({ "Hero Specific","Tinkerr" }, "Enabled", "", false)
Tinker.Version = Menu.AddOptionSlider({ "Hero Specific","Tinkerr" }, "Version", "- Bug fixes", 1,1,1)
Menu.SetValueName(Tinker.Version, 1, "4.3.3")
Tinker.DMGCalculator = Menu.AddOptionSlider({ "Hero Specific","Tinkerr", "Extra" }, "DMG Calculator", "", 1, 3)
...
Tinker.KillIndicator = Menu.AddOptionBool({ "Hero Specific","Tinkerr", "Extra" }, "Kill Indicator", "",false)
Tinker.FailRockets = Menu.AddOptionBool({ "Hero Specific","Tinkerr", "Extra", "Fail Switch" }, "Fail Rockets", "",false)
Tinker.FailRearm = Menu.AddOptionBool({ "Hero Specific","Tinkerr", "Extra", "Fail Switch" }, "Fail Rearm", "",false)

Tinker.ExtraSoul = Menu.AddOptionBool({ "Hero Specific","Tinkerr", "Extra", "Items" }, "Soul Ring", "Cast Soul Ring before each ability", false)
Tinker.ExtraSoulT = Menu.AddOptionBSlider({ "Hero Specific","Tinkerr", "Extra", "Items" }, "Soul Ring Threshold", "", 150, 500, 50)
Tinker.ExtraBottle = Menu.AddOptionBool({ "Hero Specific","Tinkerr", "Extra", "Items" }, "Bottle", "Drink bottle on yourself before each ability", false)

Tinker.FailRearmAI = Menu.AddOptionBool({ "Hero Specific","Tinkerr", "Extra", "Fail Switch" }, "Fail Rearm - check abilities / items", "", false)
Tinker.KillSteal = Menu.AddOptionBool({ "Hero Specific","Tinkerr", "Extra" }, "Steal Kill by Spells", "", false)
